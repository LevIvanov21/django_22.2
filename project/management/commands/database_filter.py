...
class Command(BaseCommand):
    ...
    def json_read_categories():
        with open('project/fixtures/category_data.json', 'r', encoding='UTF-8') as category_file:
            data = json.load(category_file)
        return data

    @staticmethod
    def json_read_products():
        with open('project/fixtures/product_data.json', 'r', encoding='UTF-8') as product_file:
    ...
    def handle(self, *args, **options):
        ...
        with connection.cursor() as cur:
            cur.execute(f'TRUNCATE TABLE project_category RESTART IDENTITY CASCADE;')
